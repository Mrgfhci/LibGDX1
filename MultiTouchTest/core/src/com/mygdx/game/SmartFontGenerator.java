...
public class SmartFontGenerator {
    ...
    public BitmapFont createFont(FileHandle fontFile, String fontName, int fontSize) {
        ...
        Preferences fontPrefs = Gdx.app.getPreferences("com.mygdx.game");
    ...
    /** @see com.mygdx.game.SmartFontGenerator#setGeneratedFontDir(String) */
    ...
    /** @see com.mygdx.game.SmartFontGenerator#setReferenceScreenWidth(int) */
    ...
    /** @see com.mygdx.game.SmartFontGenerator#setPageSize(int) */
